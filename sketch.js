...
function preload(){
  ...
  //myFontAbel = loadFont('Abel/Abel-Regular.ttf');
}
...
//function buttonFunction() {
  //if(itemSelected === 'Bellota'){
    //background(255,0,0);
  //}else if (itemSelected === 'Abel') {
    //background(0,0,255);
  //}else if (itemSelected === 'Dancing Script') {
    //background(0,255,0);
  //}else if (itemSelected === 'Marker'){
    //background(0,0,0);
  //} else if (itemSelected === 'Indie Flower'){
    //background(1,1,1);
  //}
  //indie dance marker abel
//}
function changeFont(){
let font = sel.value();
